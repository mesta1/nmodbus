...
{
	[TestFixture]
	public class ModbusRTUTransportFixture1
	{
		[Test]
		public void BuildMessageFrame()
		{
			...
			Assert.AreEqual(message, new ModbusRTUTransport1().BuildMessageFrame(request));
		}
		...
		public void NumberOfBytesToReadReadCoils()
		{
			...
			Assert.AreEqual(6, ModbusRTUTransport1.NumberOfBytesToRead(frame[1], frame[2], frame[3]));
		...
		public void NumberOfBytesToReadReadCoilsNoData()
		{
			...
			Assert.AreEqual(1, ModbusRTUTransport1.NumberOfBytesToRead(frame[1], frame[2], frame[3]));
		}
		...
		public void NumberOfBytesToReadWriteCoilsResponse()
		{
			...
			Assert.AreEqual(4, ModbusRTUTransport1.NumberOfBytesToRead(frame[1], frame[2], frame[3]));
		}
	}
}
