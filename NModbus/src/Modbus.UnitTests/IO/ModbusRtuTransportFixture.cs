...
namespace Modbus.UnitTests.IO
{
	...
	public class ModbusRtuTransportFixture
	{
		...
		{
		    byte[] frameStart = new byte[] { 0x11, 0x01, 0x05, 0xCD, 0x6B, 0xB2, 0x0E, 0x1B };
		...
		{
		    byte[] frameStart = new byte[] { 0x11, 0x01, 0x00, 0, 0 };
		...
		{
		    byte[] frameStart = new byte[] { 0x11, 0x0F, 0x00, 0x13, 0x00, 0x0A, 0, 0 };
		...
		{
			byte[] frameStart = new byte[] { 0x11, 0x01, 0x00, 0x13, 0x00, 0x25 };
		...
		{
			byte[] frameStart = new byte[] { 0x11, 0x0F, 0x00, 0x13, 0x00, 0x0A, 0x02, 0xCD, 0x01 };
		...
		{
			byte[] frameStart = new byte[] { 0x11, 0x10, 0x00, 0x01, 0x00, 0x02, 0x04 };
