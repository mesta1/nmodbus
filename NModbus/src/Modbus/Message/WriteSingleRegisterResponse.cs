...
{
	public class WriteSingleRegisterResponse : ModbusMessageWithData<HoldingRegisterCollection>, IModbusMessage
	{
		...
		public WriteSingleRegisterResponse(byte slaveAddress, byte startAddress, ushort registerValue)
